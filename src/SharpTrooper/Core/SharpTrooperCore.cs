...
namespace SharpTrooper.Core
{
    ...
    {
        private readonly string apiUrl = "https://swapi.dev/api"; // could be placed into config file
        private readonly HttpClient client;

        public SharpTrooperCore()
        {
            // Modified this library HTTP Client header because the website doesn't have a secure certificate.
